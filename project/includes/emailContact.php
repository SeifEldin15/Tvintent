...
if(isset($_POST['submit'])){ 
    ...
    if(empty($subject)){ 
        $valErr .= 'Please enter massage title.<br/>'; 
    } 
    if(empty($message)){ 
                                ...
                                <td align="center" style="padding: 20px 0;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding: 10px 0;"><strong>message title:</strong></td>
                                                <td style="padding: 10px 100px;">&'.$subject.'</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px 0;"><strong>Message:</strong></td>
                                                <td style="padding: 10px 100px;">'.$message.'</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
